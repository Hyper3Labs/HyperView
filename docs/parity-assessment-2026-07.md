...
Written 2026-07-04, immediately after the panel/control refactor (PR #25)
landed. Grounded in the current code on `refactor/panel-control-2026-07-cont`,
`docs/architecture.md`, and the July gap assessment.
...
- **Representation/index split (contract level).** The right long-term shape
  for multi-vector / late-interaction / hybrid search, landed without a
  storage migration.
