...
- Do not pin layout keys as string constants; they carry a content hash that a rebuild invalidates. Use `dataset.find_layout(model=..., provider=..., geometry=..., dimension=..., method=...)`, and `dataset.list_layouts()` to see what is available.
